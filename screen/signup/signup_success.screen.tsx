  ...
  return (
    <Box>
      <Box className='flex flex-col justify-center items-center w-full h-[calc(100vh-70px)]'>
        ...
        <Box className="flex flex-col justify-center items-center border border-solid border-gray0 rounded-2xl mt-5 w-[80%] py-16 text-center">
          <Image width={60} height={61} src={logo} />

          <Box className="flex justify-center items-center mt-10">
            <Typography className="text-black labtop:text-4xl mobile:text-2xl font-medium">회원가입이 완료되었습니다</Typography>
          </Box>
          ...
          <Box className="mt-4">
            ...
            <Box className='flex flex-row flex-wrap justify-center'>
              <Typography className="text-black text-base font-regular">로그인한 후 룸메 찾기를 </Typography>
              <Typography className="text-black text-base font-regular">위한 설문조사를 진행해주세요</Typography>
            </Box>
          </Box>

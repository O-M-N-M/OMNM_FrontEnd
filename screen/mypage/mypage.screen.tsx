...
export const MyPageScreen: NextPage = () => {
  ...
  return (
    ...
    <Box component="div" sx={{ backgroundColor: '#FFFFFF', width: '100%', height: "50px", position: "absolute", fontFamily: "Spoqa Han Sans Neo", fontStyle: "normal" }}>
      ...
      <Box sx={{width: '100%', paddingLeft: "360px", paddingRight: "360px", marginTop: "120px", marginBottom: "120px" }}>
        ...
        <div style={{height: "400px"}}>
            ...
            <div style={{height: "25px"}}>
              <span style={{float:"left", fontSize: "20px", fontWeight: "500", lineHeight: "25px"}}>룸메 신청 받은 리스트</span>
              <span style={{float:"right", fontSize: "12px", fontWeight: "500", lineHeight: "15px", color:"#9B9EA1"}}>더보기</span>
            </div>
      ...
      <Box component="div" sx={{ backgroundColor: '#FBFBFB;', width: '1920px', height: "180px", position: "absolute", fontFamily: "Spoqa Han Sans Neo", fontStyle: "normal", paddingLeft: "360px", paddingRight: "360px", borderBottom: 0 }}>
        <Link href="/">

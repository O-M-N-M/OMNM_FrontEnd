...
export const MyPageChangePwScreen = () => {
  ...
  return (
    <form className='flex flex-row justify-center min-h-[calc(100vh-50px)] my-[5%]'>
      <Box>
        <MyPageLeft />
      </Box>

      <Box className='flex flex-col justify-center items-center border border-solid border-gray0 rounded-[1.25rem] w-fit h-fit px-72 py-20 ml-6'>

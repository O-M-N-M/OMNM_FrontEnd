    ...
    return (
      ...
      <Box component="div" sx={{ backgroundColor: '#FFFFFF', width: '100%', height: "50px", position: "absolute", fontFamily: "Spoqa Han Sans Neo", fontStyle: "normal" }}>
        ...
        <Box sx={{width: '100%', paddingLeft: "360px", paddingRight: "360px", marginTop: "120px", marginBottom: "120px" }}>
          ...
          {/* main content */}
          <div style={{width: "895px", height:"1100px",marginTop:"170px", marginLeft:"305px", border: "1px solid #DBDBDB", borderRadius: "20px" , padding: "64px 60px"}}>
            <div style={{height: "875px"}}>
              
                <div style={{height: "25px"}}>
                  <span style={{ fontSize: "20px", fontWeight: "500", lineHeight: "25px"}}>나의 성향 설문조사</span>
                ...
                <div style={{marginTop:"36px"}}>
                    ...
                    <div style={{gap: "20px", marginTop:"10px", width:"774px", height: "66px", border: "1px solid #DBDBDB", borderRadius: "10px",alignItems: "center" ,justifyContent: "center"}}>
                        

                    <Box sx={{ gap:"20px", display: "flex", flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>나이</Box>
                   ...
                   <Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>MBTI</Box>
                   <Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
                   </Box>
                   <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>흡연 여부</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>학과</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>생활 패턴</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>수면 패턴</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>방 청소 빈도</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>국적</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
                    <Box sx={{ width: '100%', height: "100%", display: flexbox }}>
...
<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
<Box sx={{ marginLeft:"40px", marginTop:"15px",backgroundColor: "#1CDDAD", minWidth: "72px", width: "52px", height:"36px", borderRadius: "100px", display: "table", textAlign: "center" }}>
<Box component="span" sx={{ paddingTop: "10px", display: "table-cell", width: "32px", height: "15px", fontWeight: 500, fontSize: "12px", lineHeight: "15px", color: "#FFFFFF", letterSpacing: "-0.3px" }}>문항 9</Box>
</Box>
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>군복무 여부</Box>
<Box component="span" sx={{ fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}></Box>
</Box>
</div>


<div style={{marginTop:"20px",width:"774px", height: "147px", border: "1px solid #DBDBDB", borderRadius: "10px",alignItems: "center", justifyContent: "center"}}>

<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
<Box sx={{ marginLeft:"40px", marginTop:"15px",backgroundColor: "#1CDDAD", minWidth: "72px", width: "52px", height:"36px", borderRadius: "100px", display: "table", textAlign: "center" }}>
<Box component="span" sx={{ paddingTop: "10px", display: "table-cell", width: "32px", height: "15px", fontWeight: 500, fontSize: "12px", lineHeight: "15px", color: "#FFFFFF", letterSpacing: "-0.3px" }}>소개글</Box>
</Box>
<Box component="span" sx={{ marginTop:"15px", fontWeight: 500, fontSize: "16px", lineHeight: "20px", color: "black", marginLeft: "20px",letterSpacing: "-0.3px"}}>한 줄 자기소개</Box>
<Box component="span" sx={{ fontWeight: 300, fontSize: "12px", lineHeight: "15px", color: "#9B9EA1", letterSpacing: "-0.3px", marginLeft: "20px" }}>   <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", marginTop: "36px" }}>
